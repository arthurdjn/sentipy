...
class SST(data.Dataset):
    ...
    urls = ['https://github.com/arthurdjn/sentipy/raw/master/data/stanford_sentiment_binary_dev.tsv.gz',
            'https://github.com/arthurdjn/sentipy/raw/master/data/stanford_sentiment_binary_train.tsv.gz']
    name = 'sst'
    dirname = ''
    ...
    def __init__(self, path, text_field, label_field, lemmatized_field = data.RawField(), **kwargs):
        ...
        # Get the Stanford dataset fields
    ...
    def splits(cls, text_field, label_field, root='.data',
        ...
        """
        Split SST dataset in training and testing parts.
        ...
        **kwargs : Remaining keyword arguments
        ...
        train_dataset = SST(path_train, text_field, label_field, **kwargs)
        test_dataset = SST(path_test, text_field, label_field, **kwargs)
    ...
    def iters(cls, batch_size=32, device=0, root='.data', vectors=None, **kwargs):
        ...
        root : str, optional
            The root directory that contains the SST dataset subdirectory. 
            The default is '.data'.
